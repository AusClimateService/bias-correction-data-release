...
outdir=/g/data/ia39/australian-climate-service/test-data/BARRA2/output/reanalysis/${output_grid}/BOM/ERA5/historical/hres/BARRAR2/v1/${output_freq}/${output_var}/latest-${chunking}
